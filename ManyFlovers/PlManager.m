...
{
	int pNumber = (int)[m_pDictionary integerForKey:sKey];
	return pNumber;
}
//--------------------------------------------------------
-(void) SetKeyIntegerValue: (NSString*)sKey withValue:(NSInteger) iValue;
{
    [m_pDictionary setInteger:iValue forKey:sKey];
}
//--------------------------------------------------------
-(NSInteger) GetKeyIntegetValue: (NSString*) sKey;
{
    NSInteger pNumber = [m_pDictionary integerForKey:sKey];
    return pNumber;
}
//--------------------------------------------------------

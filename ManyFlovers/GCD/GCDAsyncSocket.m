...
- (void)attachCFStreamCallbacks
{
    ...
    CFOptionFlags readStreamEvents = kCFStreamEventErrorOccurred |
    kCFStreamEventEndEncountered;

    if (!CFReadStreamSetClient(readStream, readStreamEvents,
    ...
    if (!CFWriteStreamSetClient(writeStream, writeStreamEvents,
...
//    flags |= kAddedHandshakeListener; 
    ...
    if ((readStatus == kCFStreamStatusNotOpen) || (writeStatus == 
